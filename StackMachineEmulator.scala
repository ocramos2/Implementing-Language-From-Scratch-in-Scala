...
object StackMachineEmulator {
    ...
    def emulateSingleInstruction(stack: List[Double],
        ...
        (ins, stack) match {
            ...
            case (SubI, i1 :: i2 :: tail) => ((i2 - i1) :: tail) -> env
            
            case (MultI, i1 :: i2 :: tail) => ((i1 * i2) :: tail) -> env
            
            case (DivI, i1 :: i2 :: tail) => ((i2 / i1) :: tail) -> env
    ...
    def emulateStackMachine(instructionList: List[StackMachineInstruction]): Map[String, Double] = 
        {
            //TODO: Your Code here.
            instructionList.foldLeft(List.empty[Double] -> Map.empty[String,Double])((x, SMI) => 
            { emulateSingleInstruction(x._1, x._2, SMI) })._2
        }
}